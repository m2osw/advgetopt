...
#pragma GCC diagnostic ignored "-Wfloat-equal"
            {
                bool const a1(opt.get_double("size") == 40132.0);
                CATCH_REQUIRE(a1);
                bool const a2(opt.get_double("size", 0) == 40132.0);
                CATCH_REQUIRE(a2);
            }
...
#pragma GCC diagnostic ignored "-Wfloat-equal"
        {
            bool const a1(opt.get_double("size") == 568.0);
            CATCH_REQUIRE(a1);
            bool const a2(opt.get_double("size", 0) == 568.0);
            CATCH_REQUIRE(a2);
        }
#pragma GCC diagnostic pop
        CATCH_REQUIRE(opt.get_default("size").empty());
...
#pragma GCC diagnostic ignored "-Wfloat-equal"
        {
            bool const a1(opt.get_double("size") == 4551.0);
            CATCH_REQUIRE(a1);
            bool const a2(opt.get_double("size", 0) == 4551.0);
            CATCH_REQUIRE(a2);
        }
#pragma GCC diagnostic pop
...
//                     "long",
//                     nullptr,
//                     "used to validate that invalid integers generate an error.",
//                     nullptr
//                 },
//                 {
//                     'o',
...
//             CATCH_REQUIRE(l == -1);
//             SNAP_CATCH2_NAMESPACE::push_expected_log("error: invalid number (123abc) in parameter --double.");
// 
//             std::string s;
